                                ...
                                <tr class="font-style">
                                    ...
                                    <td>
                                        @if(!empty($revenue->add_receipt))
                                            ...
                                            <a href="{{asset(Storage::url('uploads/revenue')).'/'.$revenue->add_receipt}}"  class="action-btn bg-secondary ms-2 mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="{{__('Download')}}" target="_blank"><span class="btn-inner--icon"><i class="ti ti-crosshair text-white" ></i></span></a>
                                        @else
                                            -
                                        @endif
                                    </td>
