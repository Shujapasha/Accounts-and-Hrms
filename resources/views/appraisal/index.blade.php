                                    ...
                                    @if (Gate::check('Edit Appraisal') || Gate::check('Delete Appraisal') || Gate::check('Show Appraisal'))
                                        <td class="text-right action-btns">
                                            @can('show appraisal')
                                                <a href="#" data-url="{{ route('appraisal.show', $appraisal->id) }}"
                                                    data-size="lg" data-ajax-popup="true"
                                                    data-title="{{ __('Appraisal Detail') }}" data-toggle="tooltip"
                                                    data-original-title="{{ __('View Detail') }}"
                                                    class="edit-icon bg-success"><i class="fas fa-eye"></i></a>
                                            @endcan
                                            @can('edit appraisal')
                                                <a href="#" data-url="{{ route('appraisal.edit', $appraisal->id) }}"
                                                    data-size="lg" data-ajax-popup="true"
                                                    data-title="{{ __('Edit Appraisal') }}" data-toggle="tooltip"
                                            ...
                                            @can('delete appraisal')
                                                <a href="#" class="delete-icon"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $appraisal->id }}').submit();"><i
