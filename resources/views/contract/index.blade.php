                        ...
                        <tbody>
                            ...
                            <tr class="font-style">
                                ...
                                <td>
                                    ...
                                    <span class="badge fix_badges bg-primary p-2 px-3 rounded">{{ $contract->status }}</span>
                                    @else
                                    <span class="badge fix_badges bg-danger p-2 px-3 rounded">{{ $contract->status }}</span>
                                    @endif
                                </td>
                                {{-- <td>
                                    ...
                                    @if(\Auth::user()->can('duplicate contract'))
