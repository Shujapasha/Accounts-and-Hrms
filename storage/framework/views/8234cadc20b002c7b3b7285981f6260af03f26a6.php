    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('initial_balance', null, ['class' => 'form-control', 'placeholder' => __('Enter Initial Balance')])); ?>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('account_number', null, ['class' => 'form-control', 'placeholder' => __('Enter Account Number')])); ?>
...
<?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/accountlist/create.blade.php ENDPATH**/ ?>