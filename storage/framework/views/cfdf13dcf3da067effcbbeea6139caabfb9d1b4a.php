...
<?php $__env->startSection('action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create coupon')): ?>
        <div class="float-end">
                <a href="#" data-url="<?php echo e(route('coupons.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create Coupon')); ?>"  data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" class="btn btn-sm btn-primary">
                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        ...
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="<?php echo e(route('coupons.show',$coupon->id)); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('View')); ?>" class="mx-3 btn btn-sm align-items-center">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/coupon/index.blade.php ENDPATH**/ ?>