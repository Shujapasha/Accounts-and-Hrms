        ...
        <div class="form-group col-md-6 profile d-none">
            ...
            <div class="choose-files ">
                <label for="image" >
                    ...
                    <input type="file" class="custom-input-file d-none" name="image" id="image" data-filename="image_update" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                    <img id="blah" src="<?php echo e(asset('/storage/uploads/avatar/avatar.png')); ?>" width="100" />
                </label>
            </div>
        </div>
        <div class="form-group col-md-6 profile d-none">
            ...
            <div class="choose-files ">
                <label for="resume" >
                    ...
                    <img id="blah1" alt="your image" width="100"src="<?php echo e(asset('/storage/uploads/job/resume/sample_resume_1653981149.png')); ?>"/>
                </label>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/jobApplication/create.blade.php ENDPATH**/ ?>