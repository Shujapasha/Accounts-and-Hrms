                                    ...
                                    <td>
                                        <div class="user-group">
                                            <?php $__currentLoopData = $ZoomMeeting->users($ZoomMeeting->user_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img src="<?php echo e(asset('assets/images/user/avatar-1.jpg')); ?>" alt=""
                                                    <?php if(!empty($users->avatar)): ?> src="<?php echo e($profile . '/' . $projectUser->avatar); ?>" <?php else: ?>  avatar="<?php echo e(!empty($projectUser) ? $projectUser->name : ''); ?>" <?php endif; ?>
                                                    data-bs-original-title="<?php echo e(!empty($projectUser) ? $projectUser->name : ''); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/zoom_meeting/index.blade.php ENDPATH**/ ?>