            ...
            <div class="form-group">
                ...
                <div class="choose-files ">
                    <label for="document">
                        ...
                        <img id="blah" class="mt-3" alt="your image" width="100" src="<?php echo e(asset('/storage/uploads/uploadDocument/document.png')); ?>" />
                    </label>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/documentUpload/create.blade.php ENDPATH**/ ?>