                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::text('start_date', old('start_date'), ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'placeholder'=>'Select start date']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('end_date', __('End Date'), ['class' => 'col-form-label']); ?>

                            <?php echo Form::text('end_date', old('end_date'), ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'placeholder'=>'Select end date']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/job/create.blade.php ENDPATH**/ ?>