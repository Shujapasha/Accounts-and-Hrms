    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('appraisal_date', '', ['class' => 'form-control d_filter','autocomplete'=>'off' ,'placeholder'=>'Select month' ,'required' => 'required'])); ?>
...
<?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/appraisal/create.blade.php ENDPATH**/ ?>