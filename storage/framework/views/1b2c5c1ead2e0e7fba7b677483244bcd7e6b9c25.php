                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="avatar-group hover-avatar-ungroup">
                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                        <img src="<?php echo e(!empty($application->profile) ? asset('/storage/uploads/job/profile/' . $application->profile) : asset('/storage/uploads/avatar/avatar.png')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/jobApplication/index.blade.php ENDPATH**/ ?>