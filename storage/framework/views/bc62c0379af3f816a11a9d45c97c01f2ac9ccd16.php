                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-lg-2 float-end ms-2">
                                ...
                                <tr class="font-style">
                                    ...
                                    <td>
                                        <?php if(!empty($revenue->add_receipt)): ?>
                                            <a href="<?php echo e(asset(Storage::url('uploads/revenue')).'/'.$revenue->add_receipt); ?>" download="" class="action-btn bg-primary ms-2 mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Download')); ?>" target="_blank"><span class="btn-inner--icon"><i class="ti ti-download text-white" ></i></span></a>
                                            <a href="<?php echo e(asset(Storage::url('uploads/revenue')).'/'.$revenue->add_receipt); ?>"  class="action-btn bg-secondary ms-2 mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Download')); ?>" target="_blank"><span class="btn-inner--icon"><i class="ti ti-crosshair text-white" ></i></span></a>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/revenue/index.blade.php ENDPATH**/ ?>