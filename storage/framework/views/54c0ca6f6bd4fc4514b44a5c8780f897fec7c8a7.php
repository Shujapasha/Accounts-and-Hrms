                                    ...
                                    <td>
                                        <?php if(!empty($application->resume)): ?>
                                            <span class="action-btn bg-primary ms-2">
                                                <a class="mx-3 btn btn-sm align-items-center"  href="<?php echo e(asset(Storage::url('uploads/job/resume')) . '/' . $application->resume); ?>"  data-bs-toggle="tooltip"
                                                    data-bs-original-title="<?php echo e(__('Download')); ?>"
                                                    download><i class="ti ti-download text-white"></i></a>
                                            </span>
                                            <div class="action-btn bg-secondary ms-2">
                                                <a class="mx-3 btn btn-sm align-items-center" href="<?php echo e(asset(Storage::url('uploads/job/resume')) . '/' . $application->resume); ?>" target="_blank"  >
                                    ...
                                    <td>
                                        ...
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="<?php echo e(route('job-application.show', \Crypt::encrypt($application->id))); ?>"
                                                ...
                                                data-bs-placement="top" title="<?php echo e(__('View Detail')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newaccounts\resources\views/jobApplication/candidate.blade.php ENDPATH**/ ?>